...
interface AdministrationPreviewProps {
  onNavigate: () => void
}

const AdministrationPreview = ({ onNavigate }: AdministrationPreviewProps) => {
  ...
  return (
    <motion.section
      ref={sectionRef}
      className="section-preview administration-preview"
      style={{ opacity, y }}
    >
