...
interface ClassementPreviewProps {
  onNavigate: () => void
}

const ClassementPreview = ({ onNavigate }: ClassementPreviewProps) => {
  ...
  return (
    <motion.section
      ref={sectionRef}
      className="section-preview classement-preview"
      style={{ opacity, y }}
    >
