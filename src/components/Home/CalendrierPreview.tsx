...
interface CalendrierPreviewProps {
  onNavigate: () => void
}

const CalendrierPreview = ({ onNavigate }: CalendrierPreviewProps) => {
  ...
  return (
    <motion.section
      ref={sectionRef}
      className="section-preview calendrier-preview"
      style={{ opacity, y }}
    >
...
export default CalendrierPreview
